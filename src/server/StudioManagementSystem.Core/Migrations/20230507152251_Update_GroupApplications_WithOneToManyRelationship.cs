...
{
    /// <inheritdoc />
    public partial class Update_GroupApplications_WithOneToManyRelationship : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            // re-add the table without the unique Fk constraint
            migrationBuilder.DropTable(name: "GroupApplication");
