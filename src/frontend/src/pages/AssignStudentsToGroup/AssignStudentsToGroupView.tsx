...
export default function AssignStudentsToGroupView({ assignableStudents, availableGroups, onSubmit, onFinish }: ViewProps) {
    return (
        <FormContainer>
            ...
            <Column lg={16} md={8} sm={4}>
                <StudentsToGroupForm assignableStudents={assignableStudents} availableGroups={availableGroups} onSubmit={onSubmit} onFinish={onFinish} />
            </Column>
        </FormContainer>
    );
}