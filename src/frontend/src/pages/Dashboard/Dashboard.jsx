    ...
    return (
        <Grid>
            <Column lg={16} md={8} sm={4} className='dashboard-page__banner'>
                <div className='dashboard-page__banner_content'>
            ...
            <Column lg={16} md={8} sm={4}>
                <Grid>
                    ...
                    <Column md={4} lg={9} sm={4} className='dashboard-page__description'>
                        <div className='dashboard-page__description_content'>
                    ...
                    <Column md={5} lg={{ span: 8, offset: 9 }} sm={4}>
